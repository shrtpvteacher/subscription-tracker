...
export function LandingPage() {
  ...
  const handleCancelSubscription = (subscription) => {
    if (subscription.cancelUrl) {
      ...
      if (window.confirm(`Are you sure you want to cancel ${subscription.name}? This will mark it as cancelled.`)) {
        toast({
          title: "Cancellation Initiated",
          description: `${subscription.name} cancellation process has been started. Check your email for confirmation.`,
        });
      }
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
          <div className="text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-100 mb-4 sm:mb-6">
              Subscription
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
              Take control of your recurring payments. Track subscriptions, manage due dates, 
              and never miss a payment again. Share with family members for complete transparency.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <button
                onClick={() => setShowAddDialog(true)}
                className="flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-indigo-500/25"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 text-gray-200 rounded-2xl transition-all duration-200 border border-gray-700 shadow-lg hover:shadow-xl"
              >
                <Search className="w-5 h-5" />
                <span className="hidden sm:inline">Scan for Hidden Subscriptions</span>
                <span className="sm:hidden">Scan Subscriptions</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden shadow-lg">
                ...
                <div key={subscription.id} className="p-4 hover:bg-gray-800/30 transition-colors">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 bg-orange-600/20 text-orange-400 rounded-2xl text-xs hover:bg-orange-600/30 transition-colors shadow-md"
                    >
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          toast({
                            ...
                            description: `${subscription.name} frequency changed to ${e.target.value}.`,
                          });
                        }}
                        className="text-sm bg-gray-800 border border-gray-700 rounded-xl px-3 py-1.5 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-md"
                      >
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          toast({
                            ...
                            description: `${subscription.name} payment method changed.`,
                          });
                        }}
                        className="text-sm bg-gray-800 border border-gray-700 rounded-xl px-3 py-1.5 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[150px] shadow-md"
                      >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col gap-1">
                        {subscription.contactPhone && (
                          <a 
                            href={`tel:${subscription.contactPhone}`}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-1 flex-wrap">
                        {!subscription.isPaid && (
                          <button
                            onClick={() => handleMarkAsPaid(subscription.id, subscription.name)}
                            className="p-2 text-green-400 hover:text-green-300 hover:bg-green-400/10 rounded-xl text-xs shadow-md transition-all"
                            title="Mark as paid"
                          >
                        ...
                        <button
                          onClick={() => handleChangeSubscription(subscription)}
                          className="p-2 text-yellow-400 hover:text-yellow-300 hover:bg-yellow-400/10 rounded-xl text-xs shadow-md transition-all"
                        ...
                        <button
                          onClick={() => handleCancelSubscription(subscription)}
                          className="p-2 text-orange-400 hover:text-orange-300 hover:bg-orange-400/10 rounded-xl text-xs shadow-md transition-all"
                        ...
                        <button
                          ...
                          className="p-2 text-red-400 hover:text-red-300 hover:bg-red-400/10 rounded-xl text-xs shadow-md transition-all"
          ...
          {/* Footer with Totals (only for table view) */}
          {viewMode === 'table' && (
